              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr class="rem{{$product->id}}">
                    ...
                    <td class="product-price">{{ $product->unit_price }} TK</td>
                    <td>
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control text-center"  id="quantity{{ $product->id }}" name="quantity[]" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
